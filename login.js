...
let loginCookie = document.cookie.split(';').map(cookie => cookie.split('='))



if(loginCookie[1][1] == "Successful3"){
...
logoutButton.addEventListener("click", function(loginButton, loginCookie){
		document.cookie = "cookiemaster=loggedOut;"
		document.cookie = "cookieuser=loggedOut;"
